...
const SUGGESTED_LEADERS = [
  { name: "Malik Tariq Khan", role: "District Head", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Tariq", verified: true },
  { name: "Dr. Saima Afridi", role: "Health Director", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Saima", verified: true },
  { name: "Engr. Bilal Orakzai", role: "Tech Lead", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Bilal", verified: false },
];
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
      <Card className="bg-[#032d1e] border border-[#D4AF37]/20 overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.4),0_1px_0_rgba(212,175,55,0.06)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.5),0_1px_0_rgba(212,175,55,0.14)] transition-shadow duration-300">
        <CardContent className="p-5">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-emerald-200/35 mt-0.5">
                  ...
                  <span className="italic">{timeAgo(post.created_at)}</span>
                </p>
              </div>
            </div>
            <Button
              variant="ghost"
              size="icon"
              className="text-emerald-200/30 hover:text-[#D4AF37] w-8 h-8"
            >
          ...
          {/* Content */}
          <p className="text-emerald-50/90 leading-relaxed mb-4 text-[15px]">
            {post.content}
          </p>
          ...
          <div className="pt-3 border-t border-emerald-800/20 flex items-center justify-between">
                  ...
                  <Heart
                    className={cn(
                      ...
                      liked
                        ...
                        : "text-[#D4AF37] group-hover:scale-110"
                    )}
                  />
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 transition-colors text-[#25D366] text-xs font-semibold"
            >
              <svg
      ...
      setPosts([
        {
          id: "1",
          content:
            "Welcome to the Son of Orakzai community! We are united in our mission for the progress and prosperity of our beloved district. Share your thoughts, ideas, and join our growing movement for a better tomorrow.",
        ...
        },
        {
          id: "2",
          content:
            "Khush khabri! Hamara naya Digital Skill Lab upper Orakzai mein khulne wala hai. Nojawano ko computer, coding aur freelancing ki training di jaegi bilkul free. Ye hamara mustaqbil hai!",
        ...
        },
        {
          id: "3",
          content:
            "Jirga Forum ki agli meeting 15 May ko hogi. Tamam elders aur leaders se guzarish hai ke zaroor tahrif laaen. Agenda: pani ka masla, road construction project aur nojawano ki training.",
          created_at: new Date(Date.now() - 7200000).toISOString(),
          user_id: 3,
          likes_count: 56,
          comments_count: 8,
          author: {
            name: "Jirga Secretary",
            profession: "Community Affairs",
            is_verified: false,
            avatar_url: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jirga2",
          },
        },
      ]);
    } finally {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="space-y-1.5">
                      ...
                      <p className="text-[10px] text-emerald-200/30 uppercase tracking-wider">
                  ...
                  {STORIES.map((story) => (
                    <button key={story.id} className="flex flex-col items-center gap-2 group">
                      <div className="w-16 h-24 rounded-2xl overflow-hidden border-2 border-[#D4AF37] shadow-[0_0_12px_rgba(212,175,55,0.3)] bg-emerald-900/50 relative group-hover:shadow-[0_0_22px_rgba(212,175,55,0.5)] transition-shadow">
                        ...
                        {story.isLive && (
                          <span className="absolute top-2 left-1/2 -translate-x-1/2 bg-red-500 text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full uppercase tracking-wide z-10">
                            LIVE
                          </span>
                        )}
                      ...
                      <span className="text-[10px] text-emerald-200/60 font-medium max-w-[64px] truncate">
                        {story.name}
                      </span>
                    </button>
                  ))}
              ...
              <Card className="bg-[#032d1e] border border-[#D4AF37]/20 overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
                <CardContent className="p-4">
                  <div className="flex gap-3 items-center mb-3">
                    ...
                    <div
                      className="flex-1 bg-emerald-900/40 border border-emerald-800/50 rounded-full px-5 py-2.5 text-sm text-emerald-200/40 cursor-text"
                  ...
                  <div className="mt-3 pt-3 border-t border-emerald-800/30 flex items-center justify-between">
                    <div className="flex gap-1">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-[#D4AF37] hover:bg-[#D4AF37]/10 rounded-full text-xs font-semibold gap-1.5"
                      >
                    ...
                    <Button
                      onClick={handlePost}
                      className="bg-[#D4AF37] hover:bg-[#B8962E] text-emerald-950 font-bold rounded-full px-6 text-sm"
                    >
                      Post Karen
                    </Button>
                  </div>
            ...
            <div className="hidden lg:flex lg:col-span-3 flex-col gap-4">
                  ...
                  {TRENDING.map(({ tag, count }, i) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm font-bold text-emerald-100 group-hover:text-[#D4AF37] transition-colors">
                          {tag}
                        </p>
              ...
              <Card className="bg-[#032d1e] border border-[#D4AF37]/20 p-5 shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
                ...
                <div className="space-y-4">
                  {SUGGESTED_LEADERS.map((leader) => (
                    <div key={leader.name} className="flex items-center gap-3">
                      <div className="relative flex-shrink-0">
                        <Avatar className="w-10 h-10 border-2 border-[#D4AF37]/40">
                          <AvatarImage src={leader.avatar} />
                          <AvatarFallback>{leader.name[0]}</AvatarFallback>
                        </Avatar>
                        {leader.verified && (
                          <div className="absolute -bottom-0.5 -right-0.5 bg-[#022c22] rounded-full p-0.5">
                            <VerifiedBadge />
                          </div>
                        )}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-emerald-200/40">{leader.role}</p>
                      </div>
                      <Button
                        size="sm"
                        className="bg-transparent border border-[#D4AF37]/50 text-[#D4AF37] hover:bg-[#D4AF37] hover:text-emerald-950 rounded-full text-[11px] font-bold px-3 py-1 h-auto"
                      >
                        Follow
                      </Button>
                    </div>
              ...
              <Card className="bg-gradient-to-br from-[#D4AF37] to-[#B8962E] p-5 text-emerald-950 shadow-[0_4px_24px_rgba(212,175,55,0.2)]">
                ...
                <p className="text-sm mb-4 opacity-75">
                  Verified leadership profile hasil karein aur community ko lead karein.
                </p>
