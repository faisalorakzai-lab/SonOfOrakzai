...
export const BOARD_ADVISORS: TeamMember[] = [
  ...
  },
  {
    ...
    title: "International Human Rights Observer",
    focus: "International Human Rights Law, Humanitarian Advocacy & UN Framework Compliance",
    intro: "A distinguished human rights observer based in Geneva, advising international institutions on diaspora protection frameworks and documentation standards.",
    photo: "/team/placeholder-advisor.jpg",
    linkedin: "#", twitter: "#",
    mission: "To uphold the highest standards of international human rights documentation and diaspora advocacy — ensuring every displaced or migrant community has a protected institutional voice.",
    bio: "Dr. Elena Rostova is a highly distinguished international human rights observer and Senior International Advisor at Orakzai.org. Based in Geneva, Switzerland — the global centre of humanitarian law — her distinguished career spans over two decades of frontline advocacy, institutional documentation, and UN-framework compliance consulting for diaspora and displaced communities. Her rigorous approach to rights verification and humanitarian standards provides Orakzai.org's governance structure with elite international credibility, ensuring its advocacy frameworks meet the highest global benchmarks recognised by international humanitarian bodies.",
  ...
  },
  {
    id: 115,
    name: "Marcus Vance",
    title: "Global Migration Policy Director",
    focus: "Migration Policy Architecture, Cross-Border Compliance & Diaspora Integration Strategy",
    intro: "A leading migration policy strategist based in London, shaping transnational diaspora frameworks and cross-border humanitarian corridors.",
    photo: "/team/placeholder-advisor.jpg",
    linkedin: "#", twitter: "#",
    mission: "To design coherent, humane migration policy frameworks that protect diaspora communities in transit and settlement — bridging policy institutions with ground-level humanitarian realities.",
    bio: "Marcus Vance is a globally recognised migration policy strategist and International Advisor at Orakzai.org. Operating from London, United Kingdom, his work spans decades of engagement with national governments, the European Parliament, and multilateral bodies on migration legislation, diaspora rights architecture, and cross-border humanitarian corridors. His presence on the advisory council equips Orakzai.org with the policy fluency and institutional access required to navigate complex international migration environments, ensuring the organisation's diaspora programs meet world-class governance standards.",
  ...
  },
  {
    ...
    title: "Diaspora Relief Coordinator",
    focus: "Humanitarian Relief Logistics, Diaspora Fundraising Networks & Cross-Border Aid Delivery",
    intro: "A veteran diaspora relief coordinator based in Dubai, building and managing Gulf-region humanitarian pipelines that connect diaspora donors with field operations.",
    photo: "/team/placeholder-advisor.jpg",
    linkedin: "#", twitter: "#",
    mission: "To ensure that diaspora philanthropy translates into real, measurable relief on the ground — eliminating gaps between donor intent and field delivery through rigorous coordination and trust-based networks.",
    bio: "Sarah Al-Hassan is a distinguished humanitarian operations professional and International Advisor at Orakzai.org. Based in Dubai, UAE, her career has been defined by building efficient, accountable diaspora-funded relief networks across the Gulf Cooperation Council region. Her expertise in logistics, donor relations, and cross-border compliance enables Orakzai.org to rapidly mobilise humanitarian resources from Gulf-based diaspora communities toward verified ground operations in Pakistan. Her advisory role strengthens the organisation's credibility and operational capacity across the Gulf corridor.",
  ...
  },
  {
    ...
    focus: "International Non-Profit Law, Institutional Governance & Cross-Border Legal Compliance",
    intro: "A leading Paris-based international attorney providing pro-bono legal counsel on institutional governance, non-profit compliance, and cross-border legal frameworks.",
    photo: "/team/placeholder-advisor.jpg",
    linkedin: "#", twitter: "#",
    mission: "To ensure every institutional framework Orakzai.org operates within is legally sound, transparent, and internationally recognised — providing pro-bono legal architecture that protects the organisation's beneficiaries and donors alike.",
    bio: "Jean-Luc Dubois is a distinguished international attorney and Pro-Bono Legal Advisor at Orakzai.org. Based in Paris, France, his legal practice specialises in international non-profit governance, institutional compliance, and cross-border legal structuring for humanitarian organisations operating across multiple jurisdictions. His voluntary commitment to Orakzai.org reflects his belief in the organisation's mission — and his advisory contribution ensures its governance, membership structures, and relief disbursement mechanisms operate with absolute legal integrity across French, European, and international legal frameworks.",
  ...
  },
  {
    ...
    title: "Healthcare Access Partner",
    focus: "Global Health Systems, Community Healthcare Access & Medical Aid Program Design",
    intro: "A distinguished healthcare access specialist based in Doha, designing scalable medical aid frameworks for underserved diaspora and remote communities.",
    photo: "/team/placeholder-advisor.jpg",
    linkedin: "#", twitter: "#",
    mission: "To ensure every Orakzai community — whether in Pakistan or the diaspora — has access to dignified, professional healthcare through scalable, partnerships-driven medical access frameworks.",
    bio: "Dr. Amina Al-Mansoor is a highly accomplished global health specialist and International Healthcare Advisor at Orakzai.org. Serving from Doha, Qatar, she brings deep expertise in healthcare system design, mobile medical program implementation, and cross-border health access frameworks for diaspora and remote populations. Her advisory partnership with Orakzai.org has helped shape the organisation's healthcare pillar — from mobile clinic deployment strategy to chronic care access programs in Orakzai District — ensuring medical initiatives meet international standards of care, dignity, and reach.",
    location: "Doha, Qatar",
    reportsTo: "Faisal Orakzai",
  },
];
...
export const GLOBAL_LEADERSHIP: TeamMember[] = [
  ...
  },
  {
    ...
    slug: "asfandyar-orakzai-surrey",
    title: "Global Leadership (Data & Insights Specialist, University of Surrey)",
    focus: "Scalable Reporting, Automated Data Solutions & Strategic Decision Analytics",
    intro: "A highly skilled data infrastructure professional serving as a Data & Insights Specialist at the University of Surrey, building automated data solutions and scalable reporting frameworks.",
    photo: "/team/asfandyar-orakzai-surrey.jpg",
    linkedin: "#", twitter: "#",
    mission: "To build hyper-scalable reporting systems and engineer automated data solutions—transforming complex datasets into clear, actionable insights for strategic global stakeholders.",
    bio: "Asfandyar Orakzai is a highly skilled data infrastructure professional, insights specialist, and an esteemed member of the Global Leadership panel at Orakzai.org. Currently serving as a Data & Insights Specialist at the University of Surrey in the United Kingdom, his expertise anchors the platform with profound capabilities in building automated data solutions and managing scalable corporate reporting frameworks. Operating within the Greater Guildford Area, UK, he specializes in distilling complex, multi-tiered institutional datasets into clear, high-impact strategic decisions for key organizational leaders. His advanced analytical command and precision-driven approach to information engineering provide the advisory council with a robust quantitative foundation, ensuring data architecture operations are executed to world-class standards.",
    location: "Greater Guildford Area, United Kingdom (UK)",
  },
  {
    id: 313,
