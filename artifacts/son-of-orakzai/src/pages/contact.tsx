...
export default function Contact() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast({
        title: "Message Sent!",
        description: "Shukriya! Hum jald aap se rabita karenge.",
      });
      form.reset();
    } catch {
      toast({
        title: "Error",
        description: "Message send nahi hua. Dobara koshish karein.",
        variant: "destructive",
      });
    } finally {
      setIsPending(false);
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <p className="text-muted-foreground mb-10 leading-relaxed">
                Whether you want to volunteer, donate, or partner with us, our doors are always open.
              </p>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormField control={form.control} name="message" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea placeholder="Type your message here..." className="min-h-[150px] resize-y" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )} />
                      <Button type="submit" disabled={isPending} className="w-full bg-primary hover:bg-primary/90 text-white font-bold h-12 text-lg rounded-xl">
          ...
          <div className="mt-16 w-full h-[400px] bg-muted rounded-2xl overflow-hidden shadow-inner flex items-center justify-center relative">
            ...
            <div className="text-center z-10">
              ...
              <p className="text-muted-foreground">Khyber Pakhtunkhwa, Pakistan</p>
            </div>
          </div>
        </div>
      </section>
